 ...
 * I'm currently focused on improving my ability of Mobile applications development using [**Flutter**](https://flutter.dev/)
   
 * Confident (+4 years)practicing python in backend development and data analysis [**Flutter**](https://flutter.dev/) 
